...
@Aspect
@Component
public class AfterFinallyLogging {

	//after finally advice
	//this advice works similar to the finally block of try-catch.
	@After("execution(* com.spring.aop.dao.ProducreDAO.findUsers(..))")
	public void afterFinallyfindUsers(JoinPoint thejoinPoint, Throwable theExc) {
	...
	//after throwing
	@AfterThrowing(
			pointcut="execution(* com.spring.aop.dao.ProducreDAO.findUsers(..))",
			throwing="theExc"
			)
	...
	public void afterReturningFindUsers(JoinPoint theJoinPoint, List<Producer> result) {
	...
	private void convertsAccountNamesToUpperCase(List<Producer> result) {
		
		//loop through all the accounts
		for(Producer user : result) {
