...
public class AfterReturningLogging {
	...
	//after returning
	@AfterReturning(
			pointcut="execution(* com.spring.aop.dao.UserDAO.findUsers(..))",
			returning="result"
			)
	public void afterReturningFindUsers(JoinPoint theJoinPoint, List<Users> result) {
	...
	private void convertsAccountNamesToUpperCase(List<Users> result) {
